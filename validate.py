...
from .data import feature_requires_flux_clean
from .metrics import (
    evaluate_detections,
    format_csst_report,
...
def main() -> None:
    ...
    load_flux_clean = feature_requires_flux_clean(config.get("feature_mode", "all")) or args.use_voigt_refine
    ...
    if args.use_train_split:
        ...
        wavelength, flux, flux_clean, labels = load_train_fits(
            args.train_fits,
            load_flux_clean=load_flux_clean,
        )
